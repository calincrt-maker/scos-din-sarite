    ...
    data.slides.forEach((slide, idx) => {
      ...
      const intermediateBadge = !isFirstOrLast ? `
        <div class="intermediate-logo-badge">
          <img src="assets/digi24-dark-background.png" alt="Digi24" class="inter-logo-digi" width="30" height="28">
          <img src="assets/logo_hlm_round_minimal.png" alt="Headline Management Agency" class="inter-logo-hlm" width="28" height="28">
        </div>
      ` : '';
      ...
      switch (slide.layout) {
        case 'cover':
          bodyHTML = `
            <div class="cover-production-header">
              <div class="production-logo-row cover-logo-row">
                <img src="assets/logo_headline_management.png" alt="Headline Management Agency" class="prod-logo-hlm-mgmt" width="180" height="44">
                <img src="assets/digi24-dark-background.png" alt="Digi24" class="prod-logo-digi" width="56" height="52">
                <img src="assets/logo_headline_production_hub.png" alt="Headline Production Hub" class="prod-logo-hlm-hub" width="180" height="43">
              </div>
            </div>
          ...
          bodyHTML = `
            <div class="layout-closing">
              ...
              <div class="production-section">
                <div class="production-credit-title">${slide.productionCredit || 'O PRODUCȚIE'}</div>
                <div class="production-logo-row">
                  <img src="assets/logo_headline_management.png" alt="Headline Management Agency" class="prod-logo-hlm-mgmt" width="220" height="54">
                  <img src="assets/digi24-dark-background.png" alt="Digi24" class="prod-logo-digi" width="70" height="64">
                  <img src="assets/logo_headline_production_hub.png" alt="Headline Production Hub" class="prod-logo-hlm-hub" width="220" height="53">
                </div>
              </div>

              <div class="contact-block">
                <div class="contact-name">${slide.contact.name}</div>
                <div class="contact-links">
                  <a href="mailto:${slide.contact.email}" class="contact-link">${slide.contact.email}</a>
                  <span class="contact-divider">•</span>
                  <a href="tel:${slide.contact.phone.replace(/\s/g, '')}" class="contact-link">${slide.contact.phone}</a>
                </div>
              </div>
            </div>
          `;
